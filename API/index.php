...
<html lang="en">
    <head>
        ...
        <meta name="description" content="folifenuaweb est un portfolio de création de site web, de la conception au développement">
        <meta property="og:description" content="folifenuaweb est un portfolio de création de site web, de la conception au développement">
    ...
    <!-- design section accueil -->
        <section class="home" id="home">
            <div class="home-content">
                ...
                <p>En reconversion professionnelle, je me suis engagée dans une formation intensive pour valider un titre 
                    RNCP de niveau 6 en "Conception et développement d'applications". Actuellement à la recherche d'un stage,
                ...
                <a href="documents/TAUFANA_JOELLE_DEVELOPPEUSE.pdf" download="TAUFANA_JOELLE_DEVELOPPEUSE.pdf" class="btn" >Télécharcher CV</a>
            </div>
            <div class="home-img">
        ...
        <section class="about" id="about">
            ...
            <div class="about-content">
                ...
                <p>Ayant principalement évolué dans le domaine du commerce et ayant également fondé ma propre entreprise artisanale, 
                    j'ai acquis des compétences précieuses qui enrichissent mon parcours actuel de reconversion. 
                    Ma passion pour l'apprentissage autodidacte m'a toujours guidée, et bien que mon intérêt pour l'informatique ait été présent, 
